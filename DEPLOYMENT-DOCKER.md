# Deployment MindTune API dengan Docker

Dokumen ini berisi instruksi untuk men-deploy MindTune API menggunakan Docker di VPS.
...
# Menghentikan container dan menghapus volume (HATI-HATI: ini akan menghapus data)
...
Jika terjadi masalah dengan database, coba masuk ke container database:
